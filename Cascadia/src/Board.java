...
public class Board {
    ...
    public Tile [][] storage = new Tile[10][11]; //corresponding array of Tile vars instead of String[][], useful for some functions

    //each player's board consists of a starterTile and an arrayList of tiles(tiles which the player plays every turn, are stored in the arrayList)
    ...
    public void placeWildlifeToken(Enum.Wildlife w, Player p){
        ...
        if(!skip){
            ...
            while ((this.getStorage()[xCoordinate][YCoordinate]==null) || 
