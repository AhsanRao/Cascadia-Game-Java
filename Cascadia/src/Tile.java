...
public class Tile {
    ...
    private Enum.Wildlife assocToken; //each tile(except starterTiles) have an associative token (displayed as a pair)
    ...
    //takes individual tile components as input (when we need to edit tiles)
    public String [][] tileDisplay(Enum.Terrain t, Enum.Wildlife wl1, Enum.Wildlife wl2, Enum.Wildlife wl3, boolean rotate){
        //Creating variables for different segments of the tile to avoid hardcoding
